...
import me.ikileey.psessentials.utils.UCooldown;
...
public class Cooldown {
	...
	public void addDelay(String id, String kit) {
		...
		UCooldown.setDelay(id+";"+kit, System.currentTimeMillis());
		
		map.put(id+";"+kit, System.currentTimeMillis());
	}
	
	public long getDelay(String nick, String kit) {
		String id = nick+";"+kit;
		
		if (map.containsKey(id)) return map.get(id);
		if(UCooldown.containsRegistro(id)) return UCooldown.getRegistro(id);
	...
	public void removeDelay(String id) {
		...
		if(UCooldown.containsRegistro(id)){
			UCooldown.deleteRegistro(id);
		}
	}
	
	public boolean temDelay(String id, String kit) {
		if (map.containsKey(id+";"+kit)) return true;
		if(UCooldown.containsRegistro(id+";"+kit)) return true;
		return false;
	}
